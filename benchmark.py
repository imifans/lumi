...
def classify_benchmark(
    args, label_index, training_rate, label_rate, balance=True, method=None
):
    ...
    pipeline = [norm_processor(model_cfg.input)]
    if method != "deepsense":
...
if __name__ == "__main__":
    ...
    label_test, label_estimate_test = classify_benchmark(
        args, args.label_index, train_rate, label_rate, balance=balance, method=method
    )
