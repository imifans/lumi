...
DATASET_PATH = r"/home/taylor/DataSet/shoaib"
ACT_LABELS = [
    "walking",
    "sitting",
    "standing",
                ...
                for a in range(len(ACT_LABELS)):
                    ...
                    for i in range(position_num):
                        ...
                        print(
                            ...
                            % (files[f], ACT_LABELS[a], i, exp_pos.shape[0])
                        )
                        if exp_pos.shape[0] > 0:
                            exp_pos_down = down_sample(exp_pos, target_window)
                            sensor_down = exp_pos_down[
                                : exp_pos_down.shape[0] // seq_len * seq_len, :
                            ]
